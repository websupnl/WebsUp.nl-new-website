        ...
        <div className="grid items-end gap-12 lg:grid-cols-[0.82fr_1.18fr] lg:gap-20">
          ...
          <Reveal delay={80}>
            ...
            <p className="mt-5 max-w-2xl text-lg leading-relaxed text-slate-500">
              WebsUp is bewust persoonlijk opgezet. Geen doorschuiven tussen sales, accountmanagement en development, maar korte lijnen met de persoon die jouw project bouwt. Daardoor blijven keuzes helder, technisch kloppend en passend bij jouw bedrijf.
            </p>
