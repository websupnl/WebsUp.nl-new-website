...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-30 flex h-14 items-center gap-0 overflow-hidden rounded-full border border-white/20 bg-[#25D366] shadow-[0_8px_32px_rgba(37,211,102,0.30)] transition-all duration-500 ease-out hover:pr-4 hover:shadow-[0_12px_40px_rgba(37,211,102,0.40)] active:scale-95"
      style={{ width: '56px', paddingLeft: '0' }}
    >
      {/* Groene glans overlay */}
      <div className="pointer-events-none absolute inset-0 rounded-full"
        style={{ background: 'linear-gradient(135deg, rgba(255,255,255,0.18) 0%, transparent 60%)' }} />

      {/* WhatsApp icoon — altijd zichtbaar */}
