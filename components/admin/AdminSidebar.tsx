    ...
    <aside className="hidden lg:flex flex-col w-60 bg-white border-r border-gray-100 min-h-screen sticky top-0">
      ...
      <div className="px-5 py-4 border-b border-gray-100 flex items-center gap-2">
        ...
        <span className="text-base font-bold text-gray-900 tracking-tight">
          Webs<span className="text-orange-600">Up</span>
      ...
      <div className="px-3 pb-4 space-y-0.5 border-t border-gray-100 pt-4">
        ...
        <div className="px-3 pt-2">
          ...
          <span className={`inline-block mt-1 text-xs px-2 py-0.5 rounded-full font-medium ${role === 'admin' ? 'bg-orange-50 text-orange-600' : 'bg-gray-100 text-gray-500'}`}>
